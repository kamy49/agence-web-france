...
const articleContent: Record<string, string[]> = {
  ...
  "augmenter-clients-grace-site-web-restaurant": [
    ...
    "## L'histoire de Sophie — Restaurant Le Botaniste, Paris",
    "Sophie Marchand, restauratrice dans le 11e, nous a contactés en janvier 2025. Son site existant était vieillissant, non optimisé mobile, et ses réservations en ligne représentaient moins de 5% de son activité.",
